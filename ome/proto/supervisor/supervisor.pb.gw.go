...
var (
	pattern_SupervisorNodeAPI_GetStats_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "stats", "node"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_SupervisorNodeAPI_GetProgramStats_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "stats", "program", "program_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_SupervisorNodeAPI_Start_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "program", "start"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_SupervisorNodeAPI_Restart_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "program", "restart", "program_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_SupervisorNodeAPI_Stop_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 1, 0, 4, 1, 5, 3}, []string{"api", "program", "stop", "program_id"}, "", runtime.AssumeColonVerbOpt(true)))
)
