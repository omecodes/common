...
var (
	pattern_AuthorityService_RegisterApplication_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "app", "register"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_AuthorityService_SignKey_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "sign", "key"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_AuthorityService_SignCertificate_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "app", "sign", "cert"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_AuthorityService_ValidateAuth_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"api", "auth", "validate"}, "", runtime.AssumeColonVerbOpt(true)))
)
